...
function AlertDialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "mt-1 flex flex-col-reverse gap-2 border-t pt-4 group-data-[size=sm]/alert-dialog-content:grid group-data-[size=sm]/alert-dialog-content:grid-cols-2 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
